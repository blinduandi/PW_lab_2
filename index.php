...
<div class="row">
 ...
 <div class="language d-flex justify-content-end align-self-end">
   <a href="" class="active_lang">EN</a><a href="/principala.php" class="passive_lang">RO</a>  
</div>  
...
<center>
 <div class="language_m">
  <a href="/principala.php" class="pasive_lang_m">RO</a>
<a href="" class="active_lang_m">EN</a>
</div>  
</center>
   </div>
...
<div class="container-fluid">
   <div class="row">
      <div class="col-1"></div>
      <div class="col-11">
<span class="about_us_txt">About us</span>

<div class="row mt-5">
<div class="col-5">
<span class="about_txt">
WintentGlass company is successfully working on the Romanian and Moldovan market. We work on the principle of satisfying the needs and desires of each client. We managed to gather a team of competent and experienced professionals with extensive experience in this field. Here you will find the largest selection of pergolas, terraces and shading systems in Romania and the Republic of Moldova.
</span>
</div>
...
<div class="col-3" >
   ...
   <span class="under_txt">Years of<br> experience</span>
</div>
<div class="col-3 ">
   <span class="big_txt">1000+</span><br>
      <span class="under_txt">Finished projects</span>
   </div>
<div class="col-3 ">
   <span class="big_txt">50</span><br>
   <span class="under_txt">Hired people</span>
</div>
</div>
      </div>
   </div>
...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-12">
<span class="about_us_txt_m">About us</span>
...
<div class="col-4 " >
   ...
   <span class="under_txt_m">Years of experience</span>
</div>
<div class="col-4 ">
   <span class="big_txt_m">1000+</span><br>
      <span class="under_txt_m">Finished projects</span>
   </div>
<div class="col-4 ">
   <span class="big_txt_m">50</span><br>
   <span class="under_txt_m">Hired people</span>
</div>
</div>
      </div>
   </div>
...
<div class="container">
<span class="about_us_txt" style="margin-bottom:160px;">Project</span>
<div class="row mt-4">
...
<center class="" style="margin-top: 100px;">
   <a href="project.html" class="radial-out btn-advanced btn_more d-flex justify-content-center">More projects</a>
</center>
</div>
...
<div class="container-fluid">
<span class="about_us_txt_m">Project</span>
</div>
...
<center class="mt-3">
   <button onclick="location.href = 'project.html';" class="btn_more_m d-flex justify-content-center">More projects</button>
</center>
...
<span class="about_us_txt">Services</span>
<p class="text_serv mt-4">Only here you will find a solution for the most complex structures with high quality products competent and precise assembly. Each of our specialists is constantly improving their skills in training and practical seminars
By calling us you will evaluate the quality of the services and goods that we are ready to offer you with pleasure. We know our business perfectly!</p>
<p class="txt_serv">We offer our customers a wide range of services</p>
<p class="txt_serv">High quality delivery and installation by competent specialists</p>


<div class="row justify-content-between mt-5">
<div class="col-auto">
<embed src="image/vehicol.svg" type="">
<p class="img_serv_t">The departure of a<br> specialist to the<br> object, home,<br> office in Bucharest<br> and more</p>
</div>
<div class="col-auto">
<embed src="image/ruler.svg" type="">
<p class="img_serv_t">Measuring windows<br> and demonstrating<br> catalogs, models,<br> colors</p>
</div>
<div class="col-auto">
<embed src="image/document.svg" type="">
<p class="img_serv_t">Calculating the<br> cost of the unit<br> order</p>

</div>
<div class="col-auto">
<embed src="image/discounts.svg" type="">
<p class="img_serv_t">Flexible discount<br> system</p>
</div>
<div class="col-auto">
<embed src="image/repair.svg" type="">
<p class="img_serv_t">Warranty and<br> post-warranty<br> service</p>
</div>
</div>
</div>
</section>
...
<div class="container mt-5">
<span class="about_us_txt_m">Services</span>
<p class="text_serv_m mt-4">Only here you will find a solution for the most complex structures with high quality products competent and precise assembly. Each of our specialists is constantly improving their skills in training and practical seminars
<br><br>By calling us you will evaluate the quality of the services and goods that we are ready to offer you with pleasure. We know our business perfectly!</p>
<p class="text_serv_m">We offer our customers a wide range of services</p>
<p class="text_serv_m_h">High quality delivery and installation by competent specialists</p>
...
<p class="img_serv_t">The departure of a specialist to the object, home, office in Bucharest and more</p>
</div>
<div class="col-4 mt-md-2" style="height: 100px;">
<embed src="image/ruler.svg" type="">
</div>
<div class="col-8 mt-md-2" style="height: 100px;">
<p class="img_serv_t">Measuring windows and demonstrating catalogs, models, colors</p>
</div>
...
<div class="col-8 mt-md-2" style="height: 100px;">
<p class="img_serv_t">Calculating the cost of the unit order</p>
</div>
...
<div class="col-8 mt-md-2" style="height: 100px;">
<p class="img_serv_t">Flexible discount system</p>
</div>
...
<div class="col-8 mt-md-2" style="height: 100px;">
<p class="img_serv_t">Warranty and post-warranty service</p>
</div>
</div>
</div>
</section>
...
<section id="order">
<div class="container">
<span class="order_txt">Order a call</span>
<div class="row mt-3" >
   <div class="col-6">
<form id="formId" method="POST">
  ...
  <a class="radial-out btn-advanced send_btn" onclick="myFunction()">Send the message</a>
...
<section id="order_m">
<div class="container-fluid mt-4">
<span class="order_txt_m">Order a call</span>
...
<form action="" class="mt-4" method="POST">
   ...
   <input type="submit" value="Send the message" class="send_btn_m d-flex justify-content-center mt-2">
</form>
...
<footer>
   <center>
      ...
      <span class="footer_txt_m" style="display: none;">© 2022 Wintentglass Romania. Built using WordPress and Mesmerize theme</span>
   </center>
</footer>
